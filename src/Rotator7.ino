...
const int MotorType = FWDREV;     //Please uncomment this line for the L298N DC motor driver. CONFIRMED
...
const int SensorType = LSM303DLHC;  //Please uncomment this line to use the LSM303DLHC sensor. CONFIRMED
